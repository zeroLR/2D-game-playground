...
void main() {
	...
	`}function up(r){let t=new WeakMap,e=null;function n(a){if(a&&a.isTexture){const l=a.mapping,c=l===ho||l===uo,h=l===Li||l===Di;if(c||h){let d=t.get(a);const u=d!==void 0?d.texture.pmremVersion:0;if(a.isRenderTargetTexture&&a.pmremVersion!==u)return e===null&&(e=new $a(r)),d=c?e.fromEquirectangular(a,d):e.fromCubemap(a,d),d.texture.pmremVersion=a.pmremVersion,t.set(a,d),d.texture;if(d!==void 0)return d.texture;{const p=a.image;return c&&p&&p.height>0||h&&p&&i(p)?(e===null&&(e=new $a(r)),d=c?e.fromEquirectangular(a):e.fromCubemap(a),d.texture.pmremVersion=a.pmremVersion,t.set(a,d),a.addEventListener("dispose",s),d.texture):null}}}return a}function i(a){let l=0;const c=6;for(let h=0;h<c;h++)a[h]!==void 0&&l++;return l===c}function s(a){const l=a.target;l.removeEventListener("dispose",s);const c=t.get(l);c!==void 0&&(t.delete(l),c.dispose())}function o(){t=new WeakMap,e!==null&&(e.dispose(),e=null)}return{get:n,dispose:o}}function dp(r){const t={};function e(n){if(t[n]!==void 0)return t[n];let i;switch(n){case"WEBGL_depth_texture":i=r.getExtension("WEBGL_depth_texture")||r.getExtension("MOZ_WEBGL_depth_texture")||r.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":i=r.getExtension("EXT_texture_filter_anisotropic")||r.getExtension("MOZ_EXT_texture_filter_anisotropic")||r.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":i=r.getExtension("WEBGL_compressed_texture_s3tc")||r.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||r.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":i=r.getExtension("WEBGL_compressed_texture_pvrtc")||r.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:i=r.getExtension(n)}return t[n]=i,i}return{has:function(n){return e(n)!==null},init:function(){e("EXT_color_buffer_float"),e("WEBGL_clip_cull_distance"),e("OES_texture_float_linear"),e("EXT_color_buffer_half_float"),e("WEBGL_multisampled_render_to_texture"),e("WEBGL_render_shared_exponent")},get:function(n){const i=e(n);return i===null&&Ci("THREE.WebGLRenderer: "+n+" extension not supported."),i}}}function fp(r,t,e,n){const i={},s=new WeakMap;function o(d){const u=d.target;u.index!==null&&t.remove(u.index);for(const g in u.attributes)t.remove(u.attributes[g]);u.removeEventListener("dispose",o),delete i[u.id];const p=s.get(u);p&&(t.remove(p),s.delete(u)),n.releaseStatesOfGeometry(u),u.isInstancedBufferGeometry===!0&&delete u._maxInstanceCount,e.memory.geometries--}function a(d,u){return i[u.id]===!0||(u.addEventListener("dispose",o),i[u.id]=!0,e.memory.geometries++),u}function l(d){const u=d.attributes;for(const p in u)t.update(u[p],r.ARRAY_BUFFER)}function c(d){const u=[],p=d.index,g=d.attributes.position;let _=0;if(p!==null){const v=p.array;_=p.version;for(let S=0,x=v.length;S<x;S+=3){const T=v[S+0],A=v[S+1],R=v[S+2];u.push(T,A,A,R,R,T)}}else if(g!==void 0){const v=g.array;_=g.version;for(let S=0,x=v.length/3-1;S<x;S+=3){const T=S+0,A=S+1,R=S+2;u.push(T,A,A,R,R,T)}}else return;const m=new(sl(u)?hl:ll)(u,1);m.version=_;const f=s.get(d);f&&t.remove(f),s.set(d,m)}function h(d){const u=s.get(d);if(u){const p=d.index;p!==null&&u.version<p.version&&c(d)}else c(d);return s.get(d)}return{get:a,update:l,getWireframeAttribute:h}}function pp(r,t,e){let n;function i(u){n=u}let s,o;function a(u){s=u.type,o=u.bytesPerElement}function l(u,p){r.drawElements(n,p,s,u*o),e.update(p,n,1)}function c(u,p,g){g!==0&&(r.drawElementsInstanced(n,p,s,u*o,g),e.update(p,n,g))}function h(u,p,g){if(g===0)return;t.get("WEBGL_multi_draw").multiDrawElementsWEBGL(n,p,0,s,u,0,g);let m=0;for(let f=0;f<g;f++)m+=p[f];e.update(m,n,1)}function d(u,p,g,_){if(g===0)return;const m=t.get("WEBGL_multi_draw");if(m===null)for(let f=0;f<u.length;f++)c(u[f]/o,p[f],_[f]);else{m.multiDrawElementsInstancedWEBGL(n,p,0,s,u,0,_,0,g);let f=0;for(let v=0;v<g;v++)f+=p[v]*_[v];e.update(f,n,1)}}this.setMode=i,this.setIndex=a,this.render=l,this.renderInstances=c,this.renderMultiDraw=h,this.renderMultiDrawInstances=d}function mp(r){const t={geometries:0,textures:0},e={frame:0,calls:0,triangles:0,points:0,lines:0};function n(s,o,a){switch(e.calls++,o){case r.TRIANGLES:e.triangles+=a*(s/3);break;case r.LINES:e.lines+=a*(s/2);break;case r.LINE_STRIP:e.lines+=a*(s-1);break;case r.LINE_LOOP:e.lines+=a*s;break;case r.POINTS:e.points+=a*s;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",o);break}}function i(){e.calls=0,e.triangles=0,e.points=0,e.lines=0}return{memory:t,render:e,programs:null,autoReset:!0,reset:i,update:n}}function gp(r,t,e){const n=new WeakMap,i=new he;function s(o,a,l){const c=o.morphTargetInfluences,h=a.morphAttributes.position||a.morphAttributes.normal||a.morphAttributes.color,d=h!==void 0?h.length:0;let u=n.get(a);if(u===void 0||u.count!==d){let E=function(){L.dispose(),n.delete(a),a.removeEventListener("dispose",E)};var p=E;u!==void 0&&u.texture.dispose();const g=a.morphAttributes.position!==void 0,_=a.morphAttributes.normal!==void 0,m=a.morphAttributes.color!==void 0,f=a.morphAttributes.position||[],v=a.morphAttributes.normal||[],S=a.morphAttributes.color||[];let x=0;g===!0&&(x=1),_===!0&&(x=2),m===!0&&(x=3);let T=a.attributes.position.count*x,A=1;T>t.maxTextureSize&&(A=Math.ceil(T/t.maxTextureSize),T=t.maxTextureSize);const R=new Float32Array(T*A*4*d),L=new rl(R,T,A,d);L.type=Pn,L.needsUpdate=!0;const w=x*4;for(let P=0;P<d;P++){const G=f[P],I=v[P],F=S[P],O=T*A*4*P;for(let N=0;N<G.count;N++){const Y=N*w;g===!0&&(i.fromBufferAttribute(G,N),R[O+Y+0]=i.x,R[O+Y+1]=i.y,R[O+Y+2]=i.z,R[O+Y+3]=0),_===!0&&(i.fromBufferAttribute(I,N),R[O+Y+4]=i.x,R[O+Y+5]=i.y,R[O+Y+6]=i.z,R[O+Y+7]=0),m===!0&&(i.fromBufferAttribute(F,N),R[O+Y+8]=i.x,R[O+Y+9]=i.y,R[O+Y+10]=i.z,R[O+Y+11]=F.itemSize===4?i.w:1)}}u={count:d,texture:L,size:new Kt(T,A)},n.set(a,u),a.addEventListener("dispose",E)}if(o.isInstancedMesh===!0&&o.morphTexture!==null)l.getUniforms().setValue(r,"morphTexture",o.morphTexture,e);else{let g=0;for(let m=0;m<c.length;m++)g+=c[m];const _=a.morphTargetsRelative?1:1-g;l.getUniforms().setValue(r,"morphTargetBaseInfluence",_),l.getUniforms().setValue(r,"morphTargetInfluences",c)}l.getUniforms().setValue(r,"morphTargetsTexture",u.texture,e),l.getUniforms().setValue(r,"morphTargetsTextureSize",u.size)}return{update:s}}function _p(r,t,e,n){let i=new WeakMap;function s(l){const c=n.render.frame,h=l.geometry,d=t.get(l,h);if(i.get(d)!==c&&(t.update(d),i.set(d,c)),l.isInstancedMesh&&(l.hasEventListener("dispose",a)===!1&&l.addEventListener("dispose",a),i.get(l)!==c&&(e.update(l.instanceMatrix,r.ARRAY_BUFFER),l.instanceColor!==null&&e.update(l.instanceColor,r.ARRAY_BUFFER),i.set(l,c))),l.isSkinnedMesh){const u=l.skeleton;i.get(u)!==c&&(u.update(),i.set(u,c))}return d}function o(){i=new WeakMap}function a(l){const c=l.target;c.removeEventListener("dispose",a),e.remove(c.instanceMatrix),c.instanceColor!==null&&e.remove(c.instanceColor)}return{update:s,dispose:o}}const xl=new Ue,Ja=new ml(1,1),yl=new rl,Ml=new Hh,Sl=new fl,Qa=[],tc=[],ec=new Float32Array(16),nc=new Float32Array(9),ic=new Float32Array(4);function zi(r,t,e){const n=r[0];if(n<=0||n>0)return r;const i=t*e;let s=Qa[i];if(s===void 0&&(s=new Float32Array(i),Qa[i]=s),t!==0){n.toArray(s,0);for(let o=1,a=0;o!==t;++o)a+=e,r[o].toArray(s,a)}return s}function xe(r,t){if(r.length!==t.length)return!1;for(let e=0,n=r.length;e<n;e++)if(r[e]!==t[e])return!1;return!0}function ye(r,t){for(let e=0,n=t.length;e<n;e++)r[e]=t[e]}function lr(r,t){let e=tc[t];e===void 0&&(e=new Int32Array(t),tc[t]=e);for(let n=0;n!==t;++n)e[n]=r.allocateTextureUnit();return e}function vp(r,t){const e=this.cache;e[0]!==t&&(r.uniform1f(this.addr,t),e[0]=t)}function xp(r,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(r.uniform2f(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(xe(e,t))return;r.uniform2fv(this.addr,t),ye(e,t)}}function yp(r,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(r.uniform3f(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else if(t.r!==void 0)(e[0]!==t.r||e[1]!==t.g||e[2]!==t.b)&&(r.uniform3f(this.addr,t.r,t.g,t.b),e[0]=t.r,e[1]=t.g,e[2]=t.b);else{if(xe(e,t))return;r.uniform3fv(this.addr,t),ye(e,t)}}function Mp(r,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(r.uniform4f(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(xe(e,t))return;r.uniform4fv(this.addr,t),ye(e,t)}}function Sp(r,t){const e=this.cache,n=t.elements;if(n===void 0){if(xe(e,t))return;r.uniformMatrix2fv(this.addr,!1,t),ye(e,t)}else{if(xe(e,n))return;ic.set(n),r.uniformMatrix2fv(this.addr,!1,ic),ye(e,n)}}function Ep(r,t){const e=this.cache,n=t.elements;if(n===void 0){if(xe(e,t))return;r.uniformMatrix3fv(this.addr,!1,t),ye(e,t)}else{if(xe(e,n))return;nc.set(n),r.uniformMatrix3fv(this.addr,!1,nc),ye(e,n)}}function bp(r,t){const e=this.cache,n=t.elements;if(n===void 0){if(xe(e,t))return;r.uniformMatrix4fv(this.addr,!1,t),ye(e,t)}else{if(xe(e,n))return;ec.set(n),r.uniformMatrix4fv(this.addr,!1,ec),ye(e,n)}}function wp(r,t){const e=this.cache;e[0]!==t&&(r.uniform1i(this.addr,t),e[0]=t)}function Tp(r,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(r.uniform2i(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(xe(e,t))return;r.uniform2iv(this.addr,t),ye(e,t)}}function Ap(r,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(r.uniform3i(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else{if(xe(e,t))return;r.uniform3iv(this.addr,t),ye(e,t)}}function Rp(r,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(r.uniform4i(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(xe(e,t))return;r.uniform4iv(this.addr,t),ye(e,t)}}function Cp(r,t){const e=this.cache;e[0]!==t&&(r.uniform1ui(this.addr,t),e[0]=t)}function Pp(r,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(r.uniform2ui(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(xe(e,t))return;r.uniform2uiv(this.addr,t),ye(e,t)}}function Ip(r,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(r.uniform3ui(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else{if(xe(e,t))return;r.uniform3uiv(this.addr,t),ye(e,t)}}function Lp(r,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(r.uniform4ui(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(xe(e,t))return;r.uniform4uiv(this.addr,t),ye(e,t)}}function Dp(r,t,e){const n=this.cache,i=e.allocateTextureUnit();n[0]!==i&&(r.uniform1i(this.addr,i),n[0]=i);let s;this.type===r.SAMPLER_2D_SHADOW?(Ja.compareFunction=il,s=Ja):s=xl,e.setTexture2D(t||s,i)}function Np(r,t,e){const n=this.cache,i=e.allocateTextureUnit();n[0]!==i&&(r.uniform1i(this.addr,i),n[0]=i),e.setTexture3D(t||Ml,i)}function Up(r,t,e){const n=this.cache,i=e.allocateTextureUnit();n[0]!==i&&(r.uniform1i(this.addr,i),n[0]=i),e.setTextureCube(t||Sl,i)}function Fp(r,t,e){const n=this.cache,i=e.allocateTextureUnit();n[0]!==i&&(r.uniform1i(this.addr,i),n[0]=i),e.setTexture2DArray(t||yl,i)}function Op(r){switch(r){case 5126:return vp;case 35664:return xp;case 35665:return yp;case 35666:return Mp;case 35674:return Sp;case 35675:return Ep;case 35676:return bp;case 5124:case 35670:return wp;case 35667:case 35671:return Tp;case 35668:case 35672:return Ap;case 35669:case 35673:return Rp;case 5125:return Cp;case 36294:return Pp;case 36295:return Ip;case 36296:return Lp;case 35678:case 36198:case 36298:case 36306:case 35682:return Dp;case 35679:case 36299:case 36307:return Np;case 35680:case 36300:case 36308:case 36293:return Up;case 36289:case 36303:case 36311:case 36292:return Fp}}function Bp(r,t){r.uniform1fv(this.addr,t)}function zp(r,t){const e=zi(t,this.size,2);r.uniform2fv(this.addr,e)}function kp(r,t){const e=zi(t,this.size,3);r.uniform3fv(this.addr,e)}function Hp(r,t){const e=zi(t,this.size,4);r.uniform4fv(this.addr,e)}function Vp(r,t){const e=zi(t,this.size,4);r.uniformMatrix2fv(this.addr,!1,e)}function Gp(r,t){const e=zi(t,this.size,9);r.uniformMatrix3fv(this.addr,!1,e)}function Wp(r,t){const e=zi(t,this.size,16);r.uniformMatrix4fv(this.addr,!1,e)}function Xp(r,t){r.uniform1iv(this.addr,t)}function qp(r,t){r.uniform2iv(this.addr,t)}function Yp(r,t){r.uniform3iv(this.addr,t)}function $p(r,t){r.uniform4iv(this.addr,t)}function jp(r,t){r.uniform1uiv(this.addr,t)}function Kp(r,t){r.uniform2uiv(this.addr,t)}function Zp(r,t){r.uniform3uiv(this.addr,t)}function Jp(r,t){r.uniform4uiv(this.addr,t)}function Qp(r,t,e){const n=this.cache,i=t.length,s=lr(e,i);xe(n,s)||(r.uniform1iv(this.addr,s),ye(n,s));for(let o=0;o!==i;++o)e.setTexture2D(t[o]||xl,s[o])}function tm(r,t,e){const n=this.cache,i=t.length,s=lr(e,i);xe(n,s)||(r.uniform1iv(this.addr,s),ye(n,s));for(let o=0;o!==i;++o)e.setTexture3D(t[o]||Ml,s[o])}function em(r,t,e){const n=this.cache,i=t.length,s=lr(e,i);xe(n,s)||(r.uniform1iv(this.addr,s),ye(n,s));for(let o=0;o!==i;++o)e.setTextureCube(t[o]||Sl,s[o])}function nm(r,t,e){const n=this.cache,i=t.length,s=lr(e,i);xe(n,s)||(r.uniform1iv(this.addr,s),ye(n,s));for(let o=0;o!==i;++o)e.setTexture2DArray(t[o]||yl,s[o])}function im(r){switch(r){case 5126:return Bp;case 35664:return zp;case 35665:return kp;case 35666:return Hp;case 35674:return Vp;case 35675:return Gp;case 35676:return Wp;case 5124:case 35670:return Xp;case 35667:case 35671:return qp;case 35668:case 35672:return Yp;case 35669:case 35673:return $p;case 5125:return jp;case 36294:return Kp;case 36295:return Zp;case 36296:return Jp;case 35678:case 36198:case 36298:case 36306:case 35682:return Qp;case 35679:case 36299:case 36307:return tm;case 35680:case 36300:case 36308:case 36293:return em;case 36289:case 36303:case 36311:case 36292:return nm}}class sm{constructor(t,e,n){this.id=t,this.addr=n,this.cache=[],this.type=e.type,this.setValue=Op(e.type)}}class rm{constructor(t,e,n){this.id=t,this.addr=n,this.cache=[],this.type=e.type,this.size=e.size,this.setValue=im(e.type)}}class om{constructor(t){this.id=t,this.seq=[],this.map={}}setValue(t,e,n){const i=this.seq;for(let s=0,o=i.length;s!==o;++s){const a=i[s];a.setValue(t,e[a.id],n)}}}const qr=/(\w+)(\])?(\[|\.)?/g;function sc(r,t){r.seq.push(t),r.map[t.id]=t}function am(r,t,e){const n=r.name,i=n.length;for(qr.lastIndex=0;;){const s=qr.exec(n),o=qr.lastIndex;let a=s[1];const l=s[2]==="]",c=s[3];if(l&&(a=a|0),c===void 0||c==="["&&o+2===i){sc(e,c===void 0?new sm(a,r,t):new rm(a,r,t));break}else{let d=e.map[a];d===void 0&&(d=new om(a),sc(e,d)),e=d}}}class Ks{constructor(t,e){this.seq=[],this.map={};const n=t.getProgramParameter(e,t.ACTIVE_UNIFORMS);for(let i=0;i<n;++i){const s=t.getActiveUniform(e,i),o=t.getUniformLocation(e,s.name);am(s,o,this)}}setValue(t,e,n,i){const s=this.map[e];s!==void 0&&s.setValue(t,n,i)}setOptional(t,e,n){const i=e[n];i!==void 0&&this.setValue(t,n,i)}static upload(t,e,n,i){for(let s=0,o=e.length;s!==o;++s){const a=e[s],l=n[a.id];l.needsUpdate!==!1&&a.setValue(t,l.value,i)}}static seqWithValue(t,e){const n=[];for(let i=0,s=t.length;i!==s;++i){const o=t[i];o.id in e&&n.push(o)}return n}}function rc(r,t,e){const n=r.createShader(t);return r.shaderSource(n,e),r.compileShader(n),n}const cm=37297;let lm=0;function hm(r,t){const e=r.split(`
`),n=[],i=Math.max(t-6,0),s=Math.min(t+6,e.length);for(let o=i;o<s;o++){const a=o+1;n.push(`${a===t?">":" "} ${a}: ${e[o]}`)}return n.join(`
`)}const oc=new Ot;function um(r){qt._getMatrix(oc,qt.workingColorSpace,r);const t=`mat3( ${oc.elements.map(e=>e.toFixed(4))} )`;switch(qt.getTransfer(r)){case Zs:return[t,"LinearTransferOETF"];case te:return[t,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space: ",r),[t,"LinearTransferOETF"]}}function ac(r,t,e){const n=r.getShaderParameter(t,r.COMPILE_STATUS),s=(r.getShaderInfoLog(t)||"").trim();if(n&&s==="")return"";const o=/ERROR: 0:(\d+)/.exec(s);if(o){const a=parseInt(o[1]);return e.toUpperCase()+`

`+s+`

`+hm(r.getShaderSource(t),a)}else return s}function dm(r,t){const e=um(t);return[`vec4 ${r}( vec4 value ) {`,`	return ${e[1]}( vec4( value.rgb * ${e[0]}, value.a ) );`,"}"].join(`
`)}function fm(r,t){let e;switch(t){case mh:e="Linear";break;case gh:e="Reinhard";break;case _h:e="Cineon";break;case vh:e="ACESFilmic";break;case yh:e="AgX";break;case Mh:e="Neutral";break;case xh:e="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",t),e="Linear"}return"vec3 "+r+"( vec3 color ) { return "+e+"ToneMapping( color ); }"}const Bs=new H;function pm(){qt.getLuminanceCoefficients(Bs);const r=Bs.x.toFixed(4),t=Bs.y.toFixed(4),e=Bs.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${r}, ${t}, ${e} );`,"	return dot( weights, rgb );","}"].join(`
`)}function mm(r){return[r.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",r.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(Zi).join(`
`)}function gm(r){const t=[];for(const e in r){const n=r[e];n!==!1&&t.push("#define "+e+" "+n)}return t.join(`
`)}function _m(r,t){const e={},n=r.getProgramParameter(t,r.ACTIVE_ATTRIBUTES);for(let i=0;i<n;i++){const s=r.getActiveAttrib(t,i),o=s.name;let a=1;s.type===r.FLOAT_MAT2&&(a=2),s.type===r.FLOAT_MAT3&&(a=3),s.type===r.FLOAT_MAT4&&(a=4),e[o]={type:s.type,location:r.getAttribLocation(t,o),locationSize:a}}return e}function Zi(r){return r!==""}function cc(r,t){const e=t.numSpotLightShadows+t.numSpotLightMaps-t.numSpotLightShadowsWithMaps;return r.replace(/NUM_DIR_LIGHTS/g,t.numDirLights).replace(/NUM_SPOT_LIGHTS/g,t.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,t.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,e).replace(/NUM_RECT_AREA_LIGHTS/g,t.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,t.numPointLights).replace(/NUM_HEMI_LIGHTS/g,t.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,t.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,t.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,t.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,t.numPointLightShadows)}function lc(r,t){return r.replace(/NUM_CLIPPING_PLANES/g,t.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,t.numClippingPlanes-t.numClipIntersection)}const vm=/^[ \t]*#include +<([\w\d./]+)>/gm;function Vo(r){return r.replace(vm,ym)}const xm=new Map;function ym(r,t){let e=Bt[t];if(e===void 0){const n=xm.get(t);if(n!==void 0)e=Bt[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',t,n);else throw new Error("Can not resolve #include <"+t+">")}return Vo(e)}const Mm=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function hc(r){return r.replace(Mm,Sm)}function Sm(r,t,e,n){let i="";for(let s=parseInt(t);s<parseInt(e);s++)i+=n.replace(/\[\s*i\s*\]/g,"[ "+s+" ]").replace(/UNROLLED_LOOP_INDEX/g,s);return i}function uc(r){let t=`precision ${r.precision} float;
...
#define LOW_PRECISION`),t}function Em(r){let t="SHADOWMAP_TYPE_BASIC";return r.shadowMapType===Xc?t="SHADOWMAP_TYPE_PCF":r.shadowMapType===$l?t="SHADOWMAP_TYPE_PCF_SOFT":r.shadowMapType===An&&(t="SHADOWMAP_TYPE_VSM"),t}function bm(r){let t="ENVMAP_TYPE_CUBE";if(r.envMap)switch(r.envMapMode){case Li:case Di:t="ENVMAP_TYPE_CUBE";break;case or:t="ENVMAP_TYPE_CUBE_UV";break}return t}function wm(r){let t="ENVMAP_MODE_REFLECTION";return r.envMap&&r.envMapMode===Di&&(t="ENVMAP_MODE_REFRACTION"),t}function Tm(r){let t="ENVMAP_BLENDING_NONE";if(r.envMap)switch(r.combine){case qc:t="ENVMAP_BLENDING_MULTIPLY";break;case fh:t="ENVMAP_BLENDING_MIX";break;case ph:t="ENVMAP_BLENDING_ADD";break}return t}function Am(r){const t=r.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),112)),texelHeight:n,maxMip:e}}function Rm(r,t,e,n){const i=r.getContext(),s=e.defines;let o=e.vertexShader,a=e.fragmentShader;const l=Em(e),c=bm(e),h=wm(e),d=Tm(e),u=Am(e),p=mm(e),g=gm(s),_=i.createProgram();let m,f,v=e.glslVersion?"#version "+e.glslVersion+`
...
`)+`
`+f);const S=v+m+o,x=v+f+a,T=rc(i,i.VERTEX_SHADER,S),A=rc(i,i.FRAGMENT_SHADER,x);i.attachShader(_,T),i.attachShader(_,A),e.index0AttributeName!==void 0?i.bindAttribLocation(_,0,e.index0AttributeName):e.morphTargets===!0&&i.bindAttribLocation(_,0,"position"),i.linkProgram(_);function R(P){if(r.debug.checkShaderErrors){const G=i.getProgramInfoLog(_)||"",I=i.getShaderInfoLog(T)||"",F=i.getShaderInfoLog(A)||"",O=G.trim(),N=I.trim(),Y=F.trim();let k=!0,K=!0;if(i.getProgramParameter(_,i.LINK_STATUS)===!1)if(k=!1,typeof r.debug.onShaderError=="function")r.debug.onShaderError(i,_,T,A);else{const rt=ac(i,T,"vertex"),ft=ac(i,A,"fragment");console.error("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(_,i.VALIDATE_STATUS)+`
...
`)}}function qv(r,t){const e=r.x-t.position.x,n=r.z-t.position.z,i=t.rotation.y,s=Math.cos(i),o=Math.sin(i),a=s*e-o*n,l=o*e+s*n,c=Math.max(0,Math.abs(a)-t.size.x/2),h=Math.max(0,Math.abs(l)-t.size.z/2);return c*c+h*h}function Yv(r,t,e=0){let n=null,i=Number.POSITIVE_INFINITY,s=Number.POSITIVE_INFINITY;for(const o of t.pieces){const a=qv(r,o),l=r.x-o.position.x,c=r.z-o.position.z,h=l*l+c*c,d=a<i-1e-9,u=Math.abs(a-i)<=1e-9;(d||u&&h<s)&&(n=o,i=a,s=h)}return n?{pieceId:n.id,yawRad:n.rotation.y,footprintDistance:Math.sqrt(i)}:{pieceId:null,yawRad:e,footprintDistance:Number.POSITIVE_INFINITY}}function Vc(r,t){const e=r.x-t.x,n=r.z-t.z;return e*e+n*n}function $v(r,t){const{center:e,halfExtents:n}=t.goal;return Math.abs(r.x-e.x)<=n.x&&Math.abs(r.y-e.y)<=n.y&&Math.abs(r.z-e.z)<=n.z}class jv{constructor(t){this.track=t}track;checkpointIndex=0;goalHoldSeconds=0;complete=!1;reset(){this.checkpointIndex=0,this.goalHoldSeconds=0,this.complete=!1}update(t,e,n){if(this.advanceCheckpoint(t),this.complete)return;const i=Math.min(Math.max(n,0),.1);$v(t,this.track)&&e<=this.track.goal.maxSpeed?(this.goalHoldSeconds+=i,this.goalHoldSeconds>=this.track.goal.holdSeconds&&(this.goalHoldSeconds=this.track.goal.holdSeconds,this.complete=!0)):this.goalHoldSeconds=0}recoveryPose(){return this.track.checkpoints[this.checkpointIndex].pose}snapshot(t){const e=this.nearestSection(t);return{section:e,sectionLabel:Hv[e],checkpointId:this.track.checkpoints[this.checkpointIndex].id,checkpointIndex:this.checkpointIndex,goalHoldProgress:Math.min(1,this.goalHoldSeconds/this.track.goal.holdSeconds),complete:this.complete}}advanceCheckpoint(t){for(let e=this.checkpointIndex+1;e<this.track.checkpoints.length;e+=1){const n=this.track.checkpoints[e],i=n.triggerRadius*n.triggerRadius;Vc(t,n.trigger)<=i&&(this.checkpointIndex=e)}}nearestSection(t){let e=this.track.pieces[0].section,n=Number.POSITIVE_INFINITY;for(const i of this.track.pieces){const s=Vc(t,i.position);s<n&&(n=s,e=i.section)}return e}}const ke={cameraFovDeg:76,cameraYawResponsePerSecond:4.2,ballInertia:(.35-.16)/(.35-.02),contactFriction:.48,contactRestitution:.08,tiltSensitivity:1,tiltDeadZoneDeg:1.5,tiltSaturationDeg:25,tiltSmoothingResponsePerSecond:12},cn={cameraFovDeg:{min:55,max:95,step:1},cameraYawResponsePerSecond:{min:1.5,max:10,step:.1},ballInertia:{min:0,max:1,step:.01},contactFriction:{min:.15,max:.9,step:.01},contactRestitution:{min:0,max:.25,step:.01},tiltSensitivity:{min:.5,max:2,step:.05},tiltDeadZoneDeg:{min:.25,max:4,step:.25},tiltSaturationDeg:{min:15,max:35,step:1},tiltSmoothingResponsePerSecond:{min:4,max:24,step:1}},Fl="inner-rail:p0.4-tuning:v2",Kv="inner-rail:p0.2-tuning:v1";function ln(r,t,e){return Math.min(e,Math.max(t,r))}function Tn(r,t){return typeof r=="number"&&Number.isFinite(r)?r:t}function oa(r){const t=cn.cameraFovDeg,e=cn.cameraYawResponsePerSecond,n=cn.ballInertia,i=cn.contactFriction,s=cn.contactRestitution,o=cn.tiltSensitivity,a=cn.tiltDeadZoneDeg,l=cn.tiltSaturationDeg,c=cn.tiltSmoothingResponsePerSecond;return{cameraFovDeg:ln(Tn(r.cameraFovDeg,ke.cameraFovDeg),t.min,t.max),cameraYawResponsePerSecond:ln(Tn(r.cameraYawResponsePerSecond,ke.cameraYawResponsePerSecond),e.min,e.max),ballInertia:ln(Tn(r.ballInertia,ke.ballInertia),n.min,n.max),contactFriction:ln(Tn(r.contactFriction,ke.contactFriction),i.min,i.max),contactRestitution:ln(Tn(r.contactRestitution,ke.contactRestitution),s.min,s.max),tiltSensitivity:ln(Tn(r.tiltSensitivity,ke.tiltSensitivity),o.min,o.max),tiltDeadZoneDeg:ln(Tn(r.tiltDeadZoneDeg,ke.tiltDeadZoneDeg),a.min,a.max),tiltSaturationDeg:ln(Tn(r.tiltSaturationDeg,ke.tiltSaturationDeg),l.min,l.max),tiltSmoothingResponsePerSecond:ln(Tn(r.tiltSmoothingResponsePerSecond,ke.tiltSmoothingResponsePerSecond),c.min,c.max)}}function Gc(r){if(!r)return null;try{return oa(JSON.parse(r))}catch{return null}}function Zv(){try{return Gc(localStorage.getItem(Fl))??Gc(localStorage.getItem(Kv))??{...ke}}catch{return{...ke}}}function Jv(r){try{localStorage.setItem(Fl,JSON.stringify(oa(r)))}catch{}}function Qv(r){const t=ln(r,0,1),e=.35;return e+(.02-e)*t}const to=[{group:"INPUT",key:"tiltSensitivity",label:"Tilt sensitivity",hint:"Higher = reaches full force with less physical tilt.",format:r=>`${r.toFixed(2)}×`},{group:"INPUT",key:"tiltDeadZoneDeg",label:"Neutral dead zone",hint:"Higher = more hand tremor ignored around the calibrated pose.",format:r=>`${r.toFixed(2)}°`},{group:"INPUT",key:"tiltSaturationDeg",label:"Full-force tilt",hint:"Lower = reaches maximum field sooner. Higher = larger physical tilt range.",format:r=>`${Math.round(r)}°`},{group:"INPUT",key:"tiltSmoothingResponsePerSecond",label:"Input response",hint:"Lower = softer/slower filtering. Higher = faster correction response.",format:r=>`${r.toFixed(0)}×`},{group:"PHYSICS",key:"ballInertia",label:"Ball inertia",hint:"Higher = carries momentum longer. Lower = settles faster.",format:r=>`${Math.round(r*100)}%`},{group:"PHYSICS",key:"contactFriction",label:"Track friction",hint:"Higher = stronger traction and braking authority. Lower = more slide.",format:r=>r.toFixed(2)},{group:"PHYSICS",key:"contactRestitution",label:"Contact bounce",hint:"Higher = more rebound on landings and edges. Keep restrained for comfort.",format:r=>r.toFixed(2)},{group:"CAMERA",key:"cameraFovDeg",label:"Camera zoom / FOV",hint:"Lower = tighter / closer. Higher = wider / farther.",format:r=>`${Math.round(r)}°`},{group:"CAMERA",key:"cameraYawResponsePerSecond",label:"Track follow",hint:"How quickly the view aligns to authored track direction. Ball velocity never turns the camera.",format:r=>`${r.toFixed(1)}×`}],t0=["INPUT","PHYSICS","CAMERA"];class e0{constructor(t,e,n){this.root=t,this.callbacks=n,this.values={...e},this.root.innerHTML=`
      <details class="tuning-panel">
        ...
        <div class="tuning-panel__body">
          ${t0.map(i=>`
            <section class="tuning-group" aria-label="${i.toLowerCase()} tuning">
              <p class="tuning-group__label">${i}</p>
    ...
    `,console.error("[inner-rail] bootstrap failed",e)}}function l0(r){return r.replace(/[&<>'"]/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;","'":"&#39;",'"':"&quot;"})[t]??t)}c0();
