export type BiomeId = 'teal-ruins' | 'amber-district' | 'violet-zone' | 'pale-heights' | 'storm-crown';

export const STARTING_BIOME: BiomeId = 'teal-ruins';

export const BIOME_SEQUENCE: readonly BiomeId[] = ['teal-ruins', 'amber-district', 'violet-zone', 'pale-heights', 'storm-crown'];
