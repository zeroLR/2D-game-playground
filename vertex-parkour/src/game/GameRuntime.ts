...
export class GameRuntime {
  ...
  private reset() { this.frame = { state: createInitialState(), dashDirection: 0, dashVisualTime: 0, restartRequested: false }; this.flow.reset(); this.flowTier = 'calm'; this.flowIntensity = 0; this.invulnerable = 0; this.camera.reset(); this.abyssPressure.reset(); this.events.clear(); this.fx.reset(); this.worldLifecycle.reset(); this.biomeProgress.update(this.worldLifecycle.getVisualBiome()); this.overText.text = ''; }
