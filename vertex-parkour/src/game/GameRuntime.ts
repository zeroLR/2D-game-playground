...
export class GameRuntime {
  ...
  private readonly abyss = new Graphics(); private readonly flowBackdrop = new Graphics(); private readonly flowAura = new Graphics(); private readonly surgeOverlay = new Graphics(); private readonly player = new Graphics();
