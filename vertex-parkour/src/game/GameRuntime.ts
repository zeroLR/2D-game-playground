...
export class GameRuntime {
  ...
  private devTuning: DevTuning = { ...DEFAULT_DEV_TUNING };
  private readonly movement = new MovementSystem(() => this.devTuning);
  ...
  private frame: MovementFrameState = { state: createInitialState(this.devTuning), dashDirection: 0, dashVisualTime: 0, restartRequested: false };
