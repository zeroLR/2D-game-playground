...
export function tickState(state: GameState, deltaSeconds: number): GameState {
  ...
  if (state.landingTime > 0) {
    if (landingTime <= 0) {
      ...
      velocityY = AUTO_JUMP_VELOCITY * rebound * predator;
