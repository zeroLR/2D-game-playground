...
export const SKILLS: Record<SkillId, SkillDefinition> = {
  ...
  'blink-reset': { id: 'blink-reset', archetype: 'dash', name: 'BLINK RESET', detail: 'RUSH+ LANDING BUILDS +0.45 FLOW', maxTier: 1 },
  ...
  execution: { id: 'execution', archetype: 'kill', name: 'EXECUTION', detail: 'RUSH+ KILL BUILDS BONUS FLOW', maxTier: 3 },
