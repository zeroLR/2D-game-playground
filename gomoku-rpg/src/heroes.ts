...
const SWORDMASTER_ACTIVATIONS:Partial<Record<SkillId,AbilityActivationRule>>={blink:{kind:'resource',resourceId:'momentum',amount:2},step:{kind:'condition',conditionId:'momentum-present'},sever:{kind:'resource',resourceId:'momentum',amount:3}};
const SWORDMASTER_TIMING:Partial<Record<SkillId,AbilityActionTiming>>={blink:'precommit-follow-up',step:'precommit-follow-up',sever:'triggered-follow-up'};
