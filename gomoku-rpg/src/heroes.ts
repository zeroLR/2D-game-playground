import type { AbilityEconomyDefinition } from './ability-economy';
...
/**
 * Static hero identity/catalog data. V2 makes the ability economy part of
 * hero identity while existing heroes remain on the legacy Mana adapter.
 */
...
/** Canonical v1/v2 transitional loadout shape: hero + two active skills. */
...
export const heroes:Record<HeroId,HeroDefinition>={
  vanguard:{
    ...
    signaturePassive:'fortified',abilityEconomy:LEGACY_MANA_ECONOMY,skillPool:['blink','guard','bulwark','charge'],defaultLoadout:vanguardLoadout,
  ...
  arcanist:{
    ...
    signaturePassive:'flow',abilityEconomy:LEGACY_MANA_ECONOMY,skillPool:['blink','seal','phase'],defaultLoadout:arcanistLoadout,
  ...
  shade:{
    ...
    signaturePassive:'pressure',abilityEconomy:LEGACY_MANA_ECONOMY,skillPool:['blink','corrupt'],defaultLoadout:shadeLoadout,
  ...
  architect:{
    ...
    signaturePassive:'formation',abilityEconomy:LEGACY_MANA_ECONOMY,skillPool:['blink','rally','lattice'],defaultLoadout:architectLoadout,
