...
export type CombatState={board:Cell[][];mana:number;resources:CombatResources;activePlayer:Player;guards:TimedPosition[];seals:TimedPosition[];flames:TimedPosition[];echoes:PhaseEcho[];forcedPlacements:ForcedPlacement[];corrupted:CorruptedPosition[]};
...
export function createCombatState(board:Cell[][],mana=0,activePlayer:Player=1):CombatState{return{board,mana,resources:{1:{mana},2:{mana:0}},activePlayer,guards:[],seals:[],flames:[],echoes:[],forcedPlacements:[],corrupted:[]};}
