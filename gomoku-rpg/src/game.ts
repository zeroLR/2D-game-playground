...
function count(board:Cell[][],p:Pos,player:Player,dr:number,dc:number){let n=0;for(let r=p.row+dr,c=p.col+dc;r>=0&&r<BOARD_SIZE&&c>=0&&c<BOARD_SIZE&&board[r][c]===player;r+=dr,c+=dc)n++;return n;}
