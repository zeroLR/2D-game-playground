...
const SHATTERED_GATE_ENCOUNTERS: EncounterSequenceDefinition = {
  ...
  encounters: [
    ...
    },
    {
      ...
      id: 'convergence',
      title: 'CONVERGENCE',
      objective: 'Read the drifting clusters, then collapse them into a useful Split window.',
      modifiers: [
    ...
    },
    {
      ...
      objective: 'Use Rune energy to pierce the Warden while clearing its relay lattice.',
      elite: {
        title: 'FRACTURE WARDEN',
        trait: 'rune-ward',
      },
...
export const STAGES: readonly StageDefinition[] = [
  {
    ...
    objective: 'Clear the authored formations, break the Fracture Warden, and defeat the Sentinel.',
    status: 'available',
    durationSeconds: 100,
